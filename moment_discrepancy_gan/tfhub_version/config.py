...
# Discrepancy params.
disc_arg = add_argument_group('Discrepancy')
disc_arg.add_argument('--k_moments', type=int, default=3)
disc_arg.add_argument('--do_taylor_weights', type=str2bool, default=True)
disc_arg.add_argument('--cmd_span_const', type=float, default=0.2)


# Network
net_arg = add_argument_group('Network')
net_arg.add_argument('--scale_size', type=int, default=32,
...
train_arg.add_argument('--do_pretrain', type=str2bool, default=False)
train_arg.add_argument('--load_existing', type=str2bool, default=False)
...
train_arg.add_argument('--lambda_ae_setting', type=float, default=1.0)
